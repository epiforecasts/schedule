...
0 4 * * 1 /bin/bash schedule/jobs/germany-covid-forecast/germany-covid-forecast-rt.sh > schedule/logs/germany-covid-forecast-rt.log 2>&1
# update crowd forecasts on Saturday at 5 pm
0 17 * * 6 /bin/bash schedule/jobs/germany-covid-forecast/germany-crowd-forecast-data-update.sh > schedule/logs/germany-crowd-forecast-data-update.log 2>&1
# update crowd forecasts on a Tuesday at 1 pm
0 13 * * 2 /bin/bash schedule/jobs/germany-covid-forecast/germany-crowd-forecast.sh > schedule/logs/germany-crowd-forecast.log 2>&1
