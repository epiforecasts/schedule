...
# update crowd forecasts on a Tuesday Evening at 10pm
0 22 * * 2 /bin/bash schedule/jobs/germany-crowd-forecast.sh > schedule/logs/germany-crowd-forecast.log 2>&1
